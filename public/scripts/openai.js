...
import { createCore as createTavernStageCore } from './tavernstage/scripts-openai.js';
var tavernStageCore;
function getTavernStageCore() {
 return tavernStageCore ??= createTavernStageCore({
  get IGNORE_SYMBOL() { return IGNORE_SYMBOL; },
  get INJECTION_POSITION() { return INJECTION_POSITION; },
  get MEDIA_DISPLAY() { return MEDIA_DISPLAY; },
  get MEDIA_TYPE() { return MEDIA_TYPE; },
  get Math() { return Math; },
  get Prompt() { return Prompt; },
  get ToolManager() { return ToolManager; },
  get biasCache() { return biasCache; }, set biasCache(value) { biasCache = value; },
  get calculateLogitBias() { return calculateLogitBias; },
  get chatCompletionDefaultPrompts() { return chatCompletionDefaultPrompts; },
  get clamp() { return clamp; },
  get console() { return console; },
  get createThumbnail() { return createThumbnail; },
  ...
  get getAudioDurationFromDataURL() { return getAudioDurationFromDataURL; },
  get getBase64Async() { return getBase64Async; },
  get getCustomStoppingStrings() { return getCustomStoppingStrings; },
  get getExtensionPrompt() { return getExtensionPrompt; },
  get getExtensionPromptMaxDepth() { return getExtensionPromptMaxDepth; },
  get getGroupNames() { return getGroupNames; },
  get getImageSizeFromDataURL() { return getImageSizeFromDataURL; },
  get getMediaDisplay() { return getMediaDisplay; },
  get getMediaIndex() { return getMediaIndex; },
  get getVideoDurationFromDataURL() { return getVideoDurationFromDataURL; },
  get isAudioInliningSupported() { return isAudioInliningSupported; },
  get isDataURL() { return isDataURL; },
  get isImageInliningSupported() { return isImageInliningSupported; },
  get isVideoInliningSupported() { return isVideoInliningSupported; },
  get model_list() { return model_list; },
  get name1() { return name1; },
  get name2() { return name2; },
  get oai_settings() { return oai_settings; },
  get openai_messages_count() { return openai_messages_count; }, set openai_messages_count(value) { openai_messages_count = value; },
  ...
  get promptManagerDefaultPromptOrders() { return promptManagerDefaultPromptOrders; },
  get selected_group() { return selected_group; },
  get stringFormat() { return stringFormat; },
  ...
  get validateReverseProxy() { return validateReverseProxy; },
 });
}
/*
...
const default_impersonation_prompt = getTavernStageCore().default_impersonation_prompt;
...
const default_wi_format = getTavernStageCore().default_wi_format;
const default_new_chat_prompt = getTavernStageCore().default_new_chat_prompt;
const default_new_group_chat_prompt = getTavernStageCore().default_new_group_chat_prompt;
const default_new_example_chat_prompt = getTavernStageCore().default_new_example_chat_prompt;
const default_continue_nudge_prompt = getTavernStageCore().default_continue_nudge_prompt;
const default_bias = getTavernStageCore().default_bias;
const default_personality_format = getTavernStageCore().default_personality_format;
const default_scenario_format = getTavernStageCore().default_scenario_format;
const default_group_nudge_prompt = getTavernStageCore().default_group_nudge_prompt;
const default_bias_presets = getTavernStageCore().default_bias_presets;

const max_2k = 2047;
const max_4k = getTavernStageCore().max_4k;
const max_8k = 8191;
const max_16k = 16383;
const max_32k = 32767;
const max_64k = 65535;
...
const openrouter_website_model = getTavernStageCore().openrouter_website_model;
const openai_max_stop_strings = getTavernStageCore().openai_max_stop_strings;
...
export const chat_completion_sources = getTavernStageCore().chat_completion_sources;

const character_names_behavior = getTavernStageCore().character_names_behavior;

const continue_postfix_types = getTavernStageCore().continue_postfix_types;

export const custom_prompt_post_processing_types = getTavernStageCore().custom_prompt_post_processing_types;

const openrouter_middleout_types = getTavernStageCore().openrouter_middleout_types;

export const reasoning_effort_types = getTavernStageCore().reasoning_effort_types;

export const verbosity_levels = getTavernStageCore().verbosity_levels;

export const tool_reasoning_modes = getTavernStageCore().tool_reasoning_modes;

// Providers that support interleaved reasoning forwarding in tool-call chains.
const interleaved_reasoning_providers = getTavernStageCore().interleaved_reasoning_providers;

export const ZAI_ENDPOINT = getTavernStageCore().ZAI_ENDPOINT;

export const SILICONFLOW_ENDPOINT = getTavernStageCore().SILICONFLOW_ENDPOINT;

export const MINIMAX_ENDPOINT = getTavernStageCore().MINIMAX_ENDPOINT;
...
const default_settings = getTavernStageCore().default_settings;
 ...
 */
function setOpenAIMessages(...args) { return getTavernStageCore().setOpenAIMessages.apply(this, args); }
 ...
 */
function setOpenAIMessageExamples(...args) { return getTavernStageCore().setOpenAIMessageExamples.apply(this, args); }
 ...
 */
export function parseExampleIntoIndividual(...args) { return getTavernStageCore().parseExampleIntoIndividual.apply(this, args); }

export function formatWorldInfo(...args) { return getTavernStageCore().formatWorldInfo.apply(this, args); }
 ...
 */
async function populationInjectionPrompts(...args) { return getTavernStageCore().populationInjectionPrompts.apply(this, args); }
 ...
 * @param cyclePrompt
 */
async function populateChatHistory(...args) { return getTavernStageCore().populateChatHistory.apply(this, args); }
 ...
 */
async function populateDialogueExamples(...args) { return getTavernStageCore().populateDialogueExamples.apply(this, args); }
 ...
 */
export function getPromptPosition(...args) { return getTavernStageCore().getPromptPosition.apply(this, args); }
 ...
 */
export function getPromptRole(...args) { return getTavernStageCore().getPromptRole.apply(this, args); }
 ...
 */
async function populateChatCompletion(...args) { return getTavernStageCore().populateChatCompletion.apply(this, args); }
 ...
 */
async function preparePromptsForChatCompletion(...args) { return getTavernStageCore().preparePromptsForChatCompletion.apply(this, args); }
 ...
 */
export async function prepareOpenAIMessages(...args) { return getTavernStageCore().prepareOpenAIMessages.apply(this, args); }
 ...
 */
export function getChatCompletionModel(...args) { return getTavernStageCore().getChatCompletionModel.apply(this, args); }
 ...
 */
function getReasoningEffort(...args) { return getTavernStageCore().getReasoningEffort.apply(this, args); }
 ...
 */
function getVerbosity(...args) { return getTavernStageCore().getVerbosity.apply(this, args); }
 ...
 */
export async function createGenerationParameters(...args) { return getTavernStageCore().createGenerationParameters.apply(this, args); }
...
const TokenHandler = getTavernStageCore().TokenHandler;
...
const IdentifierNotFoundError = getTavernStageCore().IdentifierNotFoundError;

// Thrown by ChatCompletion when the token budget is unexpectedly exceeded
const TokenBudgetExceededError = getTavernStageCore().TokenBudgetExceededError;

// Thrown when a character name is invalid
const InvalidCharacterNameError = getTavernStageCore().InvalidCharacterNameError;

/**
 * Used for creating, managing, and interacting with a specific message object.
 */
const Message = getTavernStageCore().Message;
 ...
 */
const MessageCollection = getTavernStageCore().MessageCollection;
 ...
 *
 */
export const ChatCompletion = getTavernStageCore().ChatCompletion;
 ...
 */
function getToolReasoningMode(...args) { return getTavernStageCore().getToolReasoningMode.apply(this, args); }
 ...
 */
function getEffectiveToolReasoningMode(...args) { return getTavernStageCore().getEffectiveToolReasoningMode.apply(this, args); }
 ...
 */
export function isReasoningSignatureSupported(...args) { return getTavernStageCore().isReasoningSignatureSupported.apply(this, args); }

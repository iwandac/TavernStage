// TavernStage shared core, extracted from public/scripts/macros/engine/MacroParser.js.
// Upstream 8172dcd0ee672d3cd9a5e5f7af134f91a45cd2b8; AGPL-3.0; source declarations: CstParser:4; MacroParser:19
...
const { CstParser } = __stage.chevrotain;
...
class MacroParser extends CstParser {
    ...
    /** @private */
    constructor() {
        super(__stage.MacroLexer.def, {
            traceInitPerf: false,
            nodeLocationTracking: 'full',
            recoveryEnabled: true,
        });
        const Tokens = __stage.MacroLexer.tokens;
    ...
    parseDocument(input) {
        ...
        const lexingResult = __stage.MacroLexer.tokenize(input);

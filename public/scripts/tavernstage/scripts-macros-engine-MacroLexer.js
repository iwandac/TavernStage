// TavernStage shared core, extracted from public/scripts/macros/engine/MacroLexer.js.
// Upstream 8172dcd0ee672d3cd9a5e5f7af134f91a45cd2b8; AGPL-3.0; source declarations: createToken,Lexer:2; IDENTIFIER_LEXER_PATTERN:8; MACRO_IDENTIFIER_PATTERN:17; MACRO_VARIABLE_SHORTHAND_PATTERN:26; modes:29; Tokens:46; enterModesMap:168; Def:175; MacroLexer:304; enter:348; exits:372; using:387
...
const { createToken, Lexer } = __stage.chevrotain;

const IDENTIFIER_LEXER_PATTERN = /[a-zA-Z][\w-_]*/;

const MACRO_IDENTIFIER_PATTERN = /^[a-zA-Z][\w-_]*$/;
...
return { createToken, Lexer, IDENTIFIER_LEXER_PATTERN, MACRO_IDENTIFIER_PATTERN, MACRO_VARIABLE_SHORTHAND_PATTERN, modes, Tokens, enterModesMap, Def, MacroLexer, enter, exits, using };
}

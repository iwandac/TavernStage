...
import { createCore as createTavernStageCore } from './tavernstage/scripts-world-info.js';
var tavernStageCore;
function getTavernStageCore() {
 return tavernStageCore ??= createTavernStageCore({
  ...
  get world_info_budget() { return world_info_budget; },
  get world_info_budget_cap() { return world_info_budget_cap; },
  get world_info_case_sensitive() { return world_info_case_sensitive; },
  get world_info_character_strategy() { return world_info_character_strategy; },
  get world_info_depth() { return world_info_depth; },
  get world_info_match_whole_words() { return world_info_match_whole_words; },
  get world_info_max_recursion_steps() { return world_info_max_recursion_steps; },
  get world_info_min_activations() { return world_info_min_activations; },
  get world_info_min_activations_depth_max() { return world_info_min_activations_depth_max; },
  get world_info_overflow_alert() { return world_info_overflow_alert; },
  get world_info_recursive() { return world_info_recursive; },
  get world_info_use_group_scoring() { return world_info_use_group_scoring; },
 });
}
...
export const world_info_insertion_strategy = getTavernStageCore().world_info_insertion_strategy;

export const world_info_logic = getTavernStageCore().world_info_logic;

/**
 * @enum {number} Possible states of the WI evaluation
 */
export const scan_state = getTavernStageCore().scan_state;
...
const sortFn = getTavernStageCore().sortFn;
...
export const METADATA_KEY = getTavernStageCore().METADATA_KEY;

export const DEFAULT_DEPTH = getTavernStageCore().DEFAULT_DEPTH;
export const DEFAULT_WEIGHT = getTavernStageCore().DEFAULT_WEIGHT;
export const MAX_SCAN_DEPTH = getTavernStageCore().MAX_SCAN_DEPTH;
const MAX_COMMENT_LENGTH = 100;
const KNOWN_DECORATORS = getTavernStageCore().KNOWN_DECORATORS;
...
const defaultGlobalScanData = getTavernStageCore().defaultGlobalScanData;

/**
 * Represents a scanning buffer for one evaluation of World Info.
 */
const WorldInfoBuffer = getTavernStageCore().WorldInfoBuffer;

/**
 * Represents a timed effects manager for World Info.
 */
const WorldInfoTimedEffects = getTavernStageCore().WorldInfoTimedEffects;
...
export const world_info_position = getTavernStageCore().world_info_position;

export const wi_anchor_position = getTavernStageCore().wi_anchor_position;
 ...
 */
export async function getWorldInfoPrompt(...args) { return getTavernStageCore().getWorldInfoPrompt.apply(this, args); }
 ...
 */
export function parseRegexFromString(...args) { return getTavernStageCore().parseRegexFromString.apply(this, args); }
 ...
 */
export const newWorldInfoEntryDefinition = getTavernStageCore().newWorldInfoEntryDefinition;

export const newWorldInfoEntryTemplate = getTavernStageCore().newWorldInfoEntryTemplate;
...
async function getCharacterLore(...args) { return getTavernStageCore().getCharacterLore.apply(this, args); }

async function getGlobalLore(...args) { return getTavernStageCore().getGlobalLore.apply(this, args); }

async function getChatLore(...args) { return getTavernStageCore().getChatLore.apply(this, args); }

async function getPersonaLore(...args) { return getTavernStageCore().getPersonaLore.apply(this, args); }

export async function getSortedEntries(...args) { return getTavernStageCore().getSortedEntries.apply(this, args); }
...
*/
function parseDecorators(...args) { return getTavernStageCore().parseDecorators.apply(this, args); }
 ...
 */
//MARK: checkWorldInfo
export async function checkWorldInfo(...args) { return getTavernStageCore().checkWorldInfo.apply(this, args); }
 ...
 */
function filterGroupsByScoring(...args) { return getTavernStageCore().filterGroupsByScoring.apply(this, args); }
 ...
 */
function filterGroupsByTimedEffects(...args) { return getTavernStageCore().filterGroupsByTimedEffects.apply(this, args); }
 ...
 */
function filterByInclusionGroups(...args) { return getTavernStageCore().filterByInclusionGroups.apply(this, args); }
...
export function convertCharacterBook(...args) { return getTavernStageCore().convertCharacterBook.apply(this, args); }
